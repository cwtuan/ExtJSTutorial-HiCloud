...
cd %webapp%
sencha  --time compile -classpath=ext/src,js page -name=page -in loadjs_dev.jspf -out WEB-INF\jsp\loadjs_fake.jspf and restore page and exclude -namespace Ext and concat -yui all-classes.js
